    ...
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-gray-800 space-y-4">
          ...
          {/* Developer Credit */}
          <div className="flex justify-center items-center pt-4 border-t border-gray-200/50 dark:border-gray-800/50">
            <div className="flex items-center gap-2 text-sm group">
              ...
              <span className="font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent group-hover:from-blue-700 group-hover:to-purple-700 transition-all">
                Muhammad Saad
              </span>
